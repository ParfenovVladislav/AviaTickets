!(function(t) {
  ...
  (Nt.Zebra_DatePicker = function(t, M) {
      ...
      e = function(t) {
        ...
        if (
          ...
          if (!t) {
            ...
            F.on(
              "click.Zebra_DatePicker_" +
                yt +
                (kt.settings.open_on_focus
                  ? " focus.Zebra_DatePicker_" + yt
                  : ""),
              function() {
              ...
              !kt.settings.readonly_element &&
                kt.settings.pair &&
                Dt.on("blur.Zebra_DatePicker_" + yt, function() {
                  var t;
                  (t = At(Nt(this).val())) &&
          ...
          if (void 0 !== G) {
            ...
            G.css("top", (k - A) / 2),
              ...
              "disabled" === Dt.attr("disabled") &&
                G.addClass("Zebra_DatePicker_Icon_Disabled");
          }
        }
        if (
          ((rt =
        ...
        Nt(window).on(
          "resize.Zebra_DatePicker_" +
            yt +
            ", orientationchange.Zebra_DatePicker_" +
            yt,
          function() {
            kt.hide();
          }
        ...
        var C =
          '<div class="Zebra_DatePicker"><table class="dp_header dp_actions"><tr><td class="dp_previous">' +
        ...
        (z = Nt(C)),
          ...
          kt.settings.always_visible instanceof jQuery ||
            (Nt(document).on("touchmove.Zebra_DatePicker_" + yt, function() {
              bt = !0;
            }),
            Nt(document).on(
                ...
                (bt = !1),
                  z.hasClass("dp_hidden") ||
                    ...
                    0 !==
                      Nt(t.target)
                        .parents()
                        .filter(".Zebra_DatePicker").length ||
                    kt.hide(!0);
              }
            ),
      ...
      zt = function(s) {
        kt.settings.pair &&
          Nt.each(kt.settings.pair, function() {
            var t,
              e = Nt(this);
            e.data && e.data("Zebra_DatePicker")
              ? ((t = e.data("Zebra_DatePicker")).update({
                  reference_date: s,
                  direction:
    ...
    (kt.settings = {}),
      ...
      (kt.destroy = function() {
        void 0 !== kt.icon &&
          (kt.icon.off("click.Zebra_DatePicker_" + yt),
    ...
    (Nt.fn.Zebra_DatePicker = function(e) {
      return this.each(function() {
        void 0 !== Nt(this).data("Zebra_DatePicker") &&
          Nt(this)
